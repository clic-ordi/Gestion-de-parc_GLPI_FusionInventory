...
'
SetupOptions = "/acceptlicense /runnow /server='http://ip_ou_domaine/glpi/plugins/fusioninventory/front/plugin_fusioninventory.communication.php' /add-firewall-exception /execmode='Service' /installtasks='Full' /installtype='from-scratch' /local='C:\Program Files\FusionInventory-Agent\' /debug='2' /S"
